...
const paymentHistory = [
    ...
    { date: '01 Sep 2026', fee: 'Transport', amount: '₦10,000', status: 'Pending', receipt: '—' },
]
        ...
        <main className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
            <div className="flex flex-wrap items-center justify-between gap-4">
                <div>
                    ...
                    <p className="mt-3 text-lg text-slate-400">Track every fee payment made for your child and download receipts whenever needed.</p>
                </div>
